...
SECRET_KEY = 'django-insecure-u@o74el)m&()7lz&)3d&l315cz*)x3vgo%m)3boypu9(sw+=1t'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

# Allow all hosts for development (replace with specific hosts in production)
ALLOWED_HOSTS = [
    'localhost',
    '127.0.0.1',
]
...
INSTALLED_APPS = [
    ...
    'custom_auth',  # Your authentication app
